...
public class MenuController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _sceneLoader = SceneLoader.Instance(); // Sử dụng SceneLoader.Instance thay vì tìm GameObject
    ...
    public void LoadNextLevel()
    {
        ...
        sceneLoader.gameObject.SetActive(true); // Kích hoạt GameObject của SceneLoader
